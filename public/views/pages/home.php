    ...
    <div class="squished-xl">
        ...
        <div class="row gutter-xl">
            <article class="column-6">
                    ...
                    <a href="?summon=components" class="btn btn-solid btn-secondary stack">Check out all the components <i class="icon icon-fw icon-code"></i></a>
            </article>
            <article class="column-6">
                    <h1>Quickstart</h1>
                    ...
                    <a class="btn btn-solid btn-secondary stack" href="https://github.com/thinktomorrow/spirit/archive/master.zip">SUMMON SPIRIT <i class="icon icon-fw icon-download"></i></a>
            </article>
            <article class="column-6">
                    ...
                    <a class="btn btn-solid btn-secondary" href="https://github.com/thinktomorrow/spirit/archive/master.zip">View the GIT <i class="icon icon-fw icon-github"></i></a>
            </article>
        </div>
