<div class="row text-center" id="top">
  <header class="hero--large">
    <div class="absolute-center">
      ...
      <a class="btn btn-o-tertiary btn-round" href="https://github.com/thinktomorrow/spirit/archive/master.zip">SUMMON SPIRIT <i class="icon icon-fw icon-download"></i></a>
    </div>
  </header>
</div>
