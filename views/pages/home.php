<div class="row text-center" id="top">
  <header class="hero--large">
    <div class="absolute-center">
      ...
      <a class="btn btn-o-secundary btn-round" href="https://github.com/thinktomorrow/spirit.git">SUMMON SPIRIT <i class="icon icon-fw icon-download"></i></a>
    </div>
  </header>
</div>
  <main class="container row main--raised squished-xl">
    <article class="column-6 text-center stack-l">
      ...
      <a href="?page=components" class="btn btn-solid btn-secundary">Check out our components</a>
      <a href="?page=components" class="btn btn-solid btn-secundary">Summon spirit</a>
    </article>
